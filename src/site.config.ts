...
export const site: SiteConfig = {
  ...
  name: "BEANIE",
  ticker: "$BEANIE",
  tagline: "one eye open. zero plans. infinite gum.",
  chain: "solana",
  ca: "",
  links: { x: "https://x.com/", buy: "https://pump.fun" },
  lore: [
    "Nobody has seen his other eye. The beanie stays down, the gum stays in.",
  ...
  character: {
    ...
    quotes: ["…", "don't look at the other eye.", "gm.", "beanie stays on.", "i'm not late. i'm early for tomorrow.", "chart's red. gum's pink. balance.", "*pop*"],
    label: "poke beanie",
    headTrack: false,
  },
  props: [],
  ...
  landing: {
    heroWord: "BEANIE",
    marquee: ["$BEANIE", "one eye open", "the beanie stays on", "infinite gum", "no brakes", "zero plans"],
    ...
    anatomy: [
      ...
      { bone: "Head", off: [-0.075, 0.75, 0.2], title: "The eye", body: "Only one is visible. It has seen every candle." },
    ...
    beats: [
      { id: "hero", kind: "hero", kicker: "ON THE BLOCK", title: "$BEANIE", body: "One eye open. Zero plans. Infinite gum.", clip: "idle", bg: "#c6ef3f", screens: 1.6,
        cam: { yaw: 0, pitch: 4, dist: 2.7, lookY: 0.5, side: 0 } },
      { id: "who", kind: "story", kicker: "WHO IS HE", title: "One eye on the chart", nav: "about", clip: "idle", bg: "#f1f1ea",
        body: "Nobody has seen his other eye. The beanie stays down, the gum stays in. He doesn't talk much. He blows bubbles and watches.",
      ...
      { id: "end", kind: "outro", title: "$BEANIE", body: "one eye open. see you on the block.", clip: "dance", bg: "#111317", screens: 1.4,
